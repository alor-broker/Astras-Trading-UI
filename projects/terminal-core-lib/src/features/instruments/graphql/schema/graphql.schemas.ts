...
import {
  ...
  AdditionalInformationFilterInput,
  AdditionalInformationSortInput,
  Amortization,
  AmortizationFilterInput,
  AmortizationSortInput,
  ApplyPolicy,
  BasicInformation,
  BasicInformationFilterInput,
  BasicInformationSortInput,
  BoardInformation,
  BoardInformationFilterInput,
  BoardInformationSortInput,
  Bond,
  BondAmortizationsArgs,
  BondCouponsArgs,
  BondEventType,
  BondEventTypeOperationFilterInput,
  BondFilterInput,
  BondOffersArgs,
  BondsConnection,
  BondsEdge,
  BondSortInput,
  BondVolumes,
  BondVolumesFilterInput,
  BondVolumesSortInput,
  BondYield,
  BondYieldFilterInput,
  BondYieldSortInput,
  BooleanOperationFilterInput,
  CostEstimate,
  CostEstimateFilterInput,
  CostEstimateSortInput,
  Coupon,
  CouponFilterInput,
  CouponSortInput,
  CouponType,
  CouponTypeOperationFilterInput,
  ...
  DividendsAggregateInfoFilterInput,
  DividendsAggregateInfoSortInput,
  DividendSortInput,
  Exchange,
  ExchangeOperationFilterInput,
  FinancialAttributes,
  FinancialAttributesFilterInput,
  FinancialAttributesSortInput,
  InitialMargin,
  InitialMarginFilterInput,
  InitialMarginSortInput,
  Instrument,
  ...
  ListFilterInputTypeOfDividendFilterInput,
  ListFilterInputTypeOfOfferFilterInput,
  ListFilterInputTypeOfTradingPeriodFilterInput,
  ListFilterInputTypeOfValuePerQuarterFilterInput,
  ListFilterInputTypeOfValuePerYearFilterInput,
  LongOperationFilterInput,
  MainIndicators,
  MainIndicatorsFilterInput,
  MainIndicatorsSortInput,
  Market,
  MarketOperationFilterInput,
  NetIncome,
  NetIncomeFilterInput,
  NullableOfCouponTypeOperationFilterInput,
  Offer,
  OfferFilterInput,
  OfferSortInput,
  Other,
  PageInfo,
  Profitability,
  ProfitabilityFilterInput,
  ProfitabilitySortInput,
  Sales,
  SalesFilterInput,
  SortEnumType,
  Stock,
  ...
  TradingDetailsSortInput,
  TradingFilterInput,
  TradingPeriod,
  TradingPeriodFilterInput,
  TradingSortInput,
  ValuePerQuarter,
  ValuePerQuarterFilterInput,
  ValuePerYear,
  ValuePerYearFilterInput
} from './graphql.types'
...
export function FinancialAttributesSchema(): z.ZodObject<Properties<FinancialAttributes>> {
  return z.object({
    ...
    tradingPeriods: z.array(z.lazy(() => TradingPeriodSchema())).nullish(),
...
export function FinancialAttributesFilterInputSchema(): z.ZodObject<Properties<FinancialAttributesFilterInput>> {
  return z.object({
    ...
    tradingPeriods: z.lazy(() => ListFilterInputTypeOfTradingPeriodFilterInputSchema().nullish()),
...
export function ListFilterInputTypeOfTradingPeriodFilterInputSchema(): z.ZodObject<Properties<ListFilterInputTypeOfTradingPeriodFilterInput>> {
  return z.object({
    all: z.lazy(() => TradingPeriodFilterInputSchema().nullish()),
    any: z.boolean().nullish(),
    none: z.lazy(() => TradingPeriodFilterInputSchema().nullish()),
    some: z.lazy(() => TradingPeriodFilterInputSchema().nullish())
  })
}
...
export function TradingPeriodSchema(): z.ZodObject<Properties<TradingPeriod>> {
  return z.object({
    __typename: z.literal('TradingPeriod').optional(),
    finish: z.string().nullish(),
    start: z.string().nullish()
  })
}

export function TradingPeriodFilterInputSchema(): z.ZodObject<Properties<TradingPeriodFilterInput>> {
  return z.object({
    and: z.array(z.lazy(() => TradingPeriodFilterInputSchema())).nullish(),
    finish: z.lazy(() => DateTimeOperationFilterInputSchema().nullish()),
    or: z.array(z.lazy(() => TradingPeriodFilterInputSchema())).nullish(),
    start: z.lazy(() => DateTimeOperationFilterInputSchema().nullish())
  })
}
