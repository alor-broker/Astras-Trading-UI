...
import {ScrollableItem} from '../../directives/scrollable-item';
import {Swipe} from '../../../../common/directives/swipe.directive';

@Component({
  selector: 'ats-scrollable-row',
  templateUrl: './scrollable-row.html',
  imports: [
  ...
  styleUrls: ['./scrollable-row.less'],
  changeDetection: ChangeDetectionStrategy.OnPush,
  encapsulation: ViewEncapsulation.None
})
export class ScrollableRow implements OnDestroy {
  readonly items = contentChildren(ScrollableItem, {descendants: true});
