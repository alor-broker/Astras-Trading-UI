import {
  CursorPagedRequest,
  CursorPagedResult
} from '../../../common/types/paging.types';
import {
  object,
  TypeOf,
  ZodObject
...
import {
  Modify,
  ZodPropertiesOf
} from '../../graphql/utils/zod-types.helper';
import {
  NewsConnection,
  NewsFilterInput,
  PageInfo,
...
import {
  GraphQlService,
  NamedClients
} from '../../graphql/services/graph-ql.service';
import {Observable} from 'rxjs';
import {Variables} from '../../graphql/utils/gql-query-builder';
import {map} from 'rxjs/operators';
import {
  NewsSchema,
  PageInfoSchema
} from '../graphql/schema/graphql.schemas';

interface GetNewsParams extends CursorPagedRequest {
  symbols: string[] | null;
...
export class NewsService {
  ...
  getNews(params: GetNewsParams): Observable<CursorPagedResult<NewsListItem[]> | null> {
