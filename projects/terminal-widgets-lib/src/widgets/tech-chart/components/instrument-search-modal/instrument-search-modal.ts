...
import {LoadingIndicator} from '@terminal-core-lib/common/components/loading-indicator/loading-indicator';
...
@Component({
  ...
  templateUrl: './instrument-search-modal.html',
  styleUrl: './instrument-search-modal.less',
  imports: [
    NzInputModule,
    TranslocoDirective,
    NzModalComponent,
...
export class InstrumentSearchModal implements OnInit, OnDestroy {
