...
import {ChartFilters} from '@terminal-widgets-lib/widgets/instruments-correlation/components/chart-filters/chart-filters';
...
@Component({
  ...
  templateUrl: './correlation-chart.html',
  styleUrls: ['./correlation-chart.less'],
  imports: [
    TranslocoDirective,
...
export class CorrelationChart implements OnInit, OnDestroy {
