...
@Component({
  selector: 'ats-blotter-orders',
  templateUrl: './blotter-orders.html',
  styleUrls: ['./blotter-orders.less'],
  imports: [
    TranslocoDirective,
    LetDirective,
    NzEmptyComponent,
...
export class BlotterOrders extends BlotterBaseTable<DisplayOrder, OrderFilter> implements OnInit {
  ...
  override settingsTableName = TableNames.OrdersTable;

  override settingsColumnsName = ColumnsNames.OrdersColumns;
