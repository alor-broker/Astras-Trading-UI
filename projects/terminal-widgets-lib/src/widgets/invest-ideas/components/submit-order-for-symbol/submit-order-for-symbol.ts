...
import {
  DASHBOARD_CONTEXT_SERVICE
} from '@terminal-core-lib/features/dashboard/services/dashboard-context-service.types';
...
import {
  MarketOrderForm
} from '@terminal-widgets-lib/widgets/order-commands/components/order-forms/market-order-form/market-order-form';
...
export class SubmitOrderForSymbol {
  readonly symbol = input.required<InstrumentKey>();
