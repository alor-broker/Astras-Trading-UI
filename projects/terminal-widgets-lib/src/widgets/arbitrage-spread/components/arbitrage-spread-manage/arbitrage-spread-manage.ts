...
import {SpreadLeg} from '@terminal-widgets-lib/widgets/arbitrage-spread/components/spread-leg/spread-leg';
...
@Component({
  ...
  templateUrl: './arbitrage-spread-manage.html',
  styleUrls: ['./arbitrage-spread-manage.less'],
  imports: [
    TranslocoDirective,
    FormsModule,
    ReactiveFormsModule,
...
export class ArbitrageSpreadManage implements OnInit {
