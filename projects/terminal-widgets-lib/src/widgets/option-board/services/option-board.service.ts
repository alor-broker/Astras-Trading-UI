...
import {CacheService} from '@terminal-core-lib/common/services/cache.service';
import {
  InstrumentOptions,
  OptionDetails,
  OptionExpiration,
...
export class OptionBoardService {
  ...
  private readonly baseUrl = `${this.coreApiUrlProvider.apiUrl}/optionsapi/v1`;
