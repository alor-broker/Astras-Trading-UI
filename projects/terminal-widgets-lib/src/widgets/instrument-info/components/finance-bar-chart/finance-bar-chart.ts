...
import {Stock} from '@terminal-core-lib/features/instruments/graphql/schema/graphql.types';
...
@Component({
  ...
  templateUrl: './finance-bar-chart.html',
  styleUrl: './finance-bar-chart.less',
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FinanceBarChart implements OnInit {
