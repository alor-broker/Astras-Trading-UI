...
import {PanelsContainer} from '@terminal-widgets-lib/widgets/scalper-order-book/components/panels/panels-container/panels-container';
import {Panel} from '@terminal-widgets-lib/widgets/scalper-order-book/components/panels/panel/panel.component';
import {TradeClustersPanel} from "../trade-clusters-panel/trade-clusters-panel";
import {TradesPanel} from '@terminal-widgets-lib/widgets/scalper-order-book/components/trades-panel/trades-panel';
...
import {ScalperOrderBookTable} from "../scalper-order-book-table/scalper-order-book-table";
...
@Component({
  ...
  templateUrl: './scalper-order-book-body.html',
  styleUrls: ['./scalper-order-book-body.less'],
  providers: [
    PriceRowsStore,
    {provide: SCALPER_ORDERBOOK_BODY_REF, useExisting: ScalperOrderBookBody},
    {provide: RULER_CONTEX, useExisting: ScalperOrderBookBody}
  ],
  imports: [
    TopPanel,
    LetDirective,
...
export class ScalperOrderBookBody implements OnInit,
  AfterViewInit,
  OnDestroy,
