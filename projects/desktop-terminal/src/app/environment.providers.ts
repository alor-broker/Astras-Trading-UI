...
import {FIREBASE_MESSAGING_CONFIG} from '@terminal-core-lib/features/push-notifications/types/firebase-messaging-config.types';
...
export function provideEnvironmentConfig(): EnvironmentProviders {
  return makeEnvironmentProviders([
    ...
    {
      provide: FIREBASE_MESSAGING_CONFIG,
      deps: [EnvironmentService],
      useFactory: () => environment.firebase,
    },
    {
