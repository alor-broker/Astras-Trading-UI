...
import {WIDGETS_SETTINGS_DESKTOP_MIGRATION_MANAGER} from '@terminal-core-lib/features/settings-sync/migrations/settings-migrations.providers';
...
@Injectable()
export class WidgetSettingsBrokerService {
  ...
  private readonly widgetSettingsDesktopMigrationManager = inject<MigrationManagerBase>(WIDGETS_SETTINGS_DESKTOP_MIGRATION_MANAGER);
