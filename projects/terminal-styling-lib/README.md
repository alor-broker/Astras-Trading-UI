...
Классы `buy-color` и `sell-color` используй, когда речь идет о сделках: собственных сделках, сделках других трейдеров, потенциальных сделках или направлении торговой операции.

Классы `positive-color` и `negative-color` используй, когда подсвечиваются величины, значение которых позитивно или негативно для трейдера.
