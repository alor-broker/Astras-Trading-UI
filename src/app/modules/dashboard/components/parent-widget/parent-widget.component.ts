...
import { ScalperOrderBookWidgetComponent } from '../../../scalper-order-book/widgets/scalper-order-book-widget/scalper-order-book-widget.component';
import { LightChartWidgetComponent } from '../../../light-chart/widgets/light-chart-widget/light-chart-widget.component';
import { InstrumentSelectWidgetComponent } from '../../../instruments/widgets/instrument-select-widget/instrument-select-widget.component';
...
import { ExchangeRateWidgetComponent } from '../../../exchange-rate/widgets/exchange-rate-widget/exchange-rate-widget.component';
import { TechChartWidgetComponent } from '../../../tech-chart/widgets/tech-chart-widget/tech-chart-widget.component';
import { AllInstrumentsWidgetComponent } from '../../../all-instruments/widgets/all-instruments-widget/all-instruments-widget.component';
import { OrderSubmitWidgetComponent } from '../../../order-commands/widgets/order-submit-widget/order-submit-widget.component';
import { OrdersBasketWidgetComponent } from '../../../orders-basket/widgets/orders-basket-widget/orders-basket-widget.component';
...
import { EventsCalendarWidgetComponent } from '../../../events-calendar/widgets/events-calendar-widget/events-calendar-widget.component';
import { OptionBoardWidgetComponent } from '../../../option-board/widgets/option-board-widget/option-board-widget.component';
import { ArbitrageSpreadWidgetComponent } from '../../../arbitrage-spread/widgets/arbitrage-spread-widget/arbitrage-spread-widget.component';
import { PortfolioSummaryWidgetComponent } from '../../../portfolio-summary/widgets/portfolio-summary-widget/portfolio-summary-widget.component';
import { InstrumentsCorrelationWidgetComponent } from '../../../instruments-correlation/widgets/instruments-correlation-widget/instruments-correlation-widget.component';
import { BondScreenerWidgetComponent } from '../../../bond-screener/widgets/bond-screener-widget/bond-screener-widget.component';
